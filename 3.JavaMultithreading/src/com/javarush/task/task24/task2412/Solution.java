    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                int compareResult1 = name1.compareTo(name2);
                if (compareResult1 != 0) {
                    ...
                    int compareResult2 = simpleDateFormat.format(date1).compareTo(simpleDateFormat.format(date2));
                    if (compareResult2 != 0) {
                        return (-compareResult2);
                    } else {
                        double open1, open2, last1, last2, change1, change2;
                        ...
                        int compareResult3 = Double.compare(change1, change2);
